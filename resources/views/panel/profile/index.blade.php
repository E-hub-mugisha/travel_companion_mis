    ...
    <table class="table table-bordered table-striped" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $profile->destination->name ?? 'N/A' }}</td>
                <td>{{ ucfirst($profile->travel_style) }}</td>
                <td>{{ $profile->start_date }} - {{ $profile->end_date }}</td>
                <td>
            ...
            <!-- Show Modal -->
            <div class="modal fade" id="showModal{{ $profile->id }}" tabindex="-1">
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-12">
                                                <div class="card widget-card border-light shadow-sm">
                                                    <div class="card-header text-bg-primary">Welcome, {{ $profile->user->name }}</div>
                                                    <div class="card-body">
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <form action="{{ route('request-travelers.store') }}" method="POST" class="col-md-12">
                                                        ...
                                                        <button type="submit" class="btn btn-primary">Request Traveler</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="POST" action="{{ route('traveler-profiles.store') }}">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Add Traveler Profile</h5>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="user_id" value="{{ auth()->id() }}">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <label>Travel Preferences</label>
                        <input type="text" name="travel_preferences" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Travel Style</label>
                        <select name="travel_style" class="form-control">
                    ...
                    <div class="mb-2">
                        <label>Travel Budget</label>
                        <input type="text" name="travel_budget" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Travel Duration</label>
                        <input type="text" name="travel_duration" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Travel Companions</label>
                        <input type="text" name="travel_companions" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Travel Experience</label>
                        <input type="text" name="travel_experience" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Travel Photos</label>
                        <input type="text" name="travel_photos" class="form-control">
                    </div>
                    <div class="mb-2">
                        <label>Start Date</label>
